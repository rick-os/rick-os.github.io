...
// 定义站点语言
const SITE_LANG = "pt-br"; // 语言代码，例如：'en', 'zh_CN', 'ja' 等。

export const siteConfig: SiteConfig = {
	title: "RickOS",
	subtitle: "The docs of an Computer Engineering student.",
	siteURL: "https://rick-os.github.io/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-07-29", // 站点开始运行日期，用于站点统计组件计算运行天数
